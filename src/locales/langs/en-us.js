const local = {
  ...
  theme: {
    ...
    configOperation: {
      ...
      copySuccessMsg: 'Copy Success, Please replace the variable "themeSettings" in "src/theme/settings.js"',
  ...
  route: {
    ...
    home: 'Home',
    prestige: 'Prestige',
    'prestige-milestone': 'Prestige Milestone',
    'milestone-setup': 'Milestone Setup',
    'claim-prestige-reward': 'Claim Prestige Reward'
  },
  page: {
    login: {
      common: {

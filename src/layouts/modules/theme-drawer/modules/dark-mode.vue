...
const icons = {
  light: 'fa6-solid:sun',
  dark: 'fa6-solid:moon',
  auto: 'fa6-solid:circle-half-stroke'
};
...
<template>
  <NDivider>{{ $t('theme_schema') }}</NDivider>
  <div class="flex-col-stretch gap-16px">
    ...
    <Transition name="sider-inverted">
      <SettingItem v-if="showSiderInverted" :label="$t('dark_sider')">
    ...
    <SettingItem :label="$t('colour_weakness')">

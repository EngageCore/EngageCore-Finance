...
function switcherClick() {
    ...
    let primaryColor1Var = primaryDefaultColor1Btn.addEventListener('click', () => {
        localStorage.setItem("primaryRGB", "82 ,116, 235");
        html.style.setProperty('--primary-rgb', `82 ,116, 235`);
        updateColors();
    })
    let primaryColor2Var = primaryDefaultColor2Btn.addEventListener('click', () => {
        localStorage.setItem("primaryRGB", "190, 165, 37");
        html.style.setProperty('--primary-rgb', `190, 165, 37`);
        updateColors();
    })
    ...
    let backgroundColor1Var = bgDefaultColor1Btn.addEventListener('click', () => {
        ...
        localStorage.setItem("zemMenu","dark");
        localStorage.setItem("zemHeader","dark");
    })
    ...
    let defaultThemeVar = defaultthemeBtn.addEventListener('click', () => {
        defaultFn();
        localStorage.setItem("zemMenu", 'default');
        localStorage.setItem("zemHeader", 'default');
    });

    /* Glassy Layout Start */
    let glassyThemeVar = glassyBtn.addEventListener('click', () => {
        glassyFn();
        localStorage.setItem("zemMenu", 'transparent');
        localStorage.setItem("zemHeader", 'transparent');
    });
    /* Glassy Layout End */
    ...
    let lightThemeVar = lightBtn.addEventListener('click', () => {
        lightFn();
        localStorage.setItem("zemHeader", 'light');
        localStorage.setItem("zemMenu", 'light');
    })
    /* Light Layout End */
    ...
    let colorMenuVar = colorMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("zemMenu", 'color');
    });
    /* Color Menu End */
    ...
    let gradientMenuVar = gradientMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("zemMenu", 'gradient');
    });
    /* Gradient Menu End */
    ...
    let colorHeaderVar = colorHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("zemHeader", 'color');
    });
    /* Color Header End */
    ...
    let gradientHeaderVar = gradientHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("zemHeader", 'gradient');
    });
    /* Gradient Header End */
    ...
    let fixedHeaderVar = fixedHeaderBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("zemheaderfixed", true);
        localStorage.removeItem("zemheaderscrollable");
    });

    let scrollHeaderVar = scrollHeaderBtn.addEventListener('click', () => {
        html.setAttribute('data-header-position', 'scrollable');
        localStorage.setItem("zemheaderscrollable", true);
        localStorage.removeItem("zemheaderfixed");
    });
    ...
    let fixedMenuVar = fixedMenuBtn.addEventListener('click', () => {
        ...
        localStorage.setItem("zemmenufixed", true);
        localStorage.removeItem("zemmenuscrollable");
    });

    let scrollMenuVar = scrollMenuBtn.addEventListener('click', () => {
        html.setAttribute('data-menu-position', 'scrollable');
        localStorage.setItem("zemmenuscrollable", true);
        localStorage.removeItem("zemmenufixed");
    });
    ...
    let defaultVar = defaultBtn.addEventListener('click', () => {
        ...
        localStorage.removeItem('zemnavstyles');
        toggleSidemenu();
    ...
    let detachedVar = detachedBtn.addEventListener('click', () => {
        detachedFn();
        localStorage.setItem("zemverticalstyles", 'detached');
    });
    /* Hover Submenu End */
    ...
    let menuClickVar = menuClickBtn.addEventListener('click', () => {
        ...
        menuClickFn();
        localStorage.setItem("zemnavstyles", 'menu-click');
        localStorage.removeItem("zemverticalstyles");
        document.querySelectorAll(".main-menu>li.open").forEach((ele)=>{
            if(!ele.classList.contains('active')){
                ele.classList.remove('open')
    ...
    let menuhoverVar = menuHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        menuhoverFn();
        localStorage.setItem("zemnavstyles", 'menu-hover');
        localStorage.removeItem("zemverticalstyles");
    ...
    let iconClickVar = iconClickBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconClickFn();
        localStorage.setItem("zemnavstyles", 'icon-click');
        localStorage.removeItem("zemverticalstyles");
    ...
    let iconhoverVar = iconHoverBtn.addEventListener('click', () => {
        html.removeAttribute('data-vertical-style');
        iconHoverFn();
        localStorage.setItem("zemnavstyles", 'icon-hover');
        localStorage.removeItem("zemverticalstyles");
...
function defaultFn() {
    ...
    html.setAttribute('data-header-styles', 'default');
    html.setAttribute('data-menu-styles', 'default');
    if(!localStorage.getItem('primaryRGB')){
        html.setAttribute('style','')
    }
    document.querySelector('#switcher-default-theme').checked = true;
    updateColors()
    localStorage.setItem("zemdefaulttheme", true);
    localStorage.removeItem("zemdarktheme");
    localStorage.removeItem("zemlighttheme");
    localStorage.removeItem("zemglassytheme");
    ...
    checkOptions();
    html.style.removeProperty('--bodyBgRGB');
...
function lightFn() {
    ...
    updateColors()
    localStorage.setItem("zemlighttheme", true);
    localStorage.removeItem("zemdarktheme");
    localStorage.removeItem("zemdefaulttheme");
    localStorage.removeItem("zemglassytheme");
    localStorage.removeItem("zembgColor");
    localStorage.removeItem("zemheaderbg");
    localStorage.removeItem("zembgwhite");
...
function darkFn() {
    ...
    updateColors()
    localStorage.setItem("zemdarktheme", true);
    localStorage.removeItem("zemdefaulttheme");
    localStorage.removeItem("zemglassytheme");
    localStorage.removeItem("zemlighttheme");
    localStorage.removeItem("bodyBgRGB");
...
function glassyFn() {
    let html = document.querySelector('html');
    html.setAttribute('data-theme-mode', 'glassy');
    html.setAttribute('data-header-styles', 'transparent');
    html.setAttribute('data-menu-styles', 'transparent');
    if(localStorage.getItem("zemlayout") == "horizontal"){
        html.setAttribute('data-menu-styles', 'transparent');
    ...
    document.querySelector('#switcher-glassy-theme').checked = true;
    document.querySelector('#switcher-menu-light').checked = true;
    document.querySelector('#switcher-header-light').checked = true;
    updateColors()
    localStorage.setItem("zemglassytheme", true);
    localStorage.removeItem("zemdefaulttheme");
    localStorage.removeItem("zemdarktheme");
    localStorage.removeItem("zemlighttheme");
    localStorage.removeItem("zembgColor");
...
function horizontalClickFn() {
    ...
    // if(!localStorage.zemMenu && !localStorage.bodylightRGB){
    //     html.setAttribute("data-menu-styles","default")
    //     document.querySelector('#switcher-menu-default').checked = true;
    //     checkOptions();
    // }
    checkOptions();
    checkHoriMenu();
...
function checkOptions() {
    ...
    // light header
    if (localStorage.getItem('zemHeader') === "light") {
        document.querySelector('#switcher-header-light').checked = true;
    }

    // color header
    if (localStorage.getItem('zemHeader') === "color") {
        document.querySelector('#switcher-header-primary').checked = true;
    }

    // gradient header
    if (localStorage.getItem('zemHeader') === "gradient") {
        document.querySelector('#switcher-header-gradient').checked = true;
    }

    // dark header
    if (localStorage.getItem('zemHeader') === "dark") {
        document.querySelector('#switcher-header-dark').checked = true;
    }
    // transparent header
    if (localStorage.getItem('zemHeader') === "transparent") {
        document.querySelector('#switcher-header-transparent').checked = true;
    }

    // light menu
    if (localStorage.getItem('zemMenu') === 'light') {
        document.querySelector('#switcher-menu-light').checked = true;
    }

    // color menu
    if (localStorage.getItem('zemMenu') === 'color') {
        document.querySelector('#switcher-menu-primary').checked = true;
    }

    // gradient menu
    if (localStorage.getItem('zemMenu') === 'gradient') {
        document.querySelector('#switcher-menu-gradient').checked = true;
    }

    // dark menu
    if (localStorage.getItem('zemMenu') === 'dark') {
        document.querySelector('#switcher-menu-dark').checked = true;
    }
    // transparent menu
    if (localStorage.getItem('zemMenu') === 'transparent') {
    ...
    //scrollable
    if (localStorage.getItem('zemheaderscrollable')) {
        document.querySelector('#switcher-header-scroll').checked = true;
    }
    if (localStorage.getItem('zemmenuscrollable')) {
        document.querySelector('#switcher-menu-scroll').checked = true;
    }

    //fixed
    if (localStorage.getItem('zemheaderfixed')) {
        document.querySelector('#switcher-header-fixed').checked = true;
    }
    if (localStorage.getItem('zemmenufixed')) {
        document.querySelector('#switcher-menu-fixed').checked = true;
    }
    ...
    if (localStorage.zemnavstyles) {
        let navStyles = localStorage.getItem('zemnavstyles');
        switch (navStyles) {
            case 'menu-click':
                document.querySelector('#switcher-menu-click').checked = true;
                break;
...
function localStorageBackup2(){
    ...
    if (localStorage.bodyBgRGB || localStorage.bodyglassyRGB){
        document.querySelector('#switcher-glassy-theme').checked = true;
    }
    ...
    if (localStorage.primaryRGB) {
        if(localStorage.primaryRGB == "82 ,116, 235"){
            document.querySelector("#switcher-primary").checked = true
        }
        if(localStorage.primaryRGB == "190, 165, 37"){

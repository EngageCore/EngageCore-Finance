(function () {
    'use strict';
    if (localStorage.getItem("zemlighttheme")) {
    ...
    if (localStorage.getItem("zemdarktheme")) {
        document.querySelector("html").setAttribute("data-theme-mode", "dark")
        document.querySelector("html").setAttribute("data-menu-styles", "dark")
        document.querySelector("html").setAttribute("data-header-styles", "dark")
    }
    if (localStorage.getItem("zemdefaulttheme")) {
        document.querySelector("html").setAttribute("data-theme-mode", "default")
        document.querySelector("html").setAttribute("data-menu-styles", "dark")
        document.querySelector("html").setAttribute("data-header-styles", "dark")
    }
    if (localStorage.getItem("zemglassytheme")) {
        document.querySelector("html").setAttribute("data-theme-mode", "glassy")
        document.querySelector("html").setAttribute("data-menu-styles", "light")
        document.querySelector("html").setAttribute("data-header-styles", "light")
    }
